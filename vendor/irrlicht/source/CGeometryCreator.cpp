...
IMesh* CGeometryCreator::createCubeMesh(const core::vector3df& size) const
{
	...
	// irr::video::IVertexDescriptor * vtx =  Driver->addVertexDescriptor("default");

	
	// vtx->addAttribute("inVertexPosition", 4, video::EVAS_POSITION, video::EVAT_FLOAT, 1);
	// vtx->addAttribute("inVertexNormal", 4, video::EVAS_NORMAL, video::EVAT_FLOAT, 1);
	// vtx->addAttribute("inVertexColor", 4, video::EVAS_COLOR, video::EVAT_UBYTE, 1);
	// vtx->addAttribute("inTexCoords", 4, video::EVAS_TEXCOORD0, video::EVAT_FLOAT, 1);
